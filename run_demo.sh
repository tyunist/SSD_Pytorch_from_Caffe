 python3.7 demo_detection.py \
    ...
    --test_img_dir /home/tynguyen/github_workspaces/github_pytorch_object_detection/pytorch_object_detection/pytorch_yolov3/data/samples/three_drones/test_from_skydio_hd_ian_house \
